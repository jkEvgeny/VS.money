...
public class CalculationMapper {
    ...
    public CalculationDto mapToDto(Calculation model) {
        ...
        return CalculationDto.builder()
                ...
                .validityPeriodFrom(model.getValidityPeriodFrom() == null ? null : model.getValidityPeriodFrom().toString())
                .validityPeriodTo(model.getValidityPeriodTo() == null ? null : model.getValidityPeriodTo().toString())
